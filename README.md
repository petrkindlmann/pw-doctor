...
See [SECURITY.md](SECURITY.md) for the full threat model and control catalogue.
...
- [docs/PRD.md](docs/PRD.md) — product framing, scope, non-goals
- [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) — module map and heal pipeline
...
- [examples/](examples) — runnable walkthrough
